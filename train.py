...
parser.add_argument('--epoch_num', default=5, help="number of epochs")
parser.add_argument('--multi_gpu', default=False, action='store_true', help="ensure multi-gpu training")
...
parser.add_argument('--ensure_corres', default=True, action='store_true', help="correspondence ablation")
parser.add_argument('--ensure_rel', default=True, action='store_true', help="relation judgement ablation")
